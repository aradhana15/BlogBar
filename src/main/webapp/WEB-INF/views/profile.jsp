...
<body bgcolor="#444444">
	<div class="center">
	<table border=0 bgcolor="white" class="center">
		<tr><td rowspan="2" width="25%">
				<table border=3 width="10%">
					<tr>
					<td>
				 		<img src="resources/images/amit.jpg" alt="User Profile">
				 </td>
				</table>
			</td>
			<!-- <tr>
			<td>
				Email id:- amitabhb@yahoo.com
			</td>
			</tr> -->
	    ...
	    <tr><td>
			<h3 class="center" color="#221177">About User</h3>
			</td></tr>
			<tr><td>
			<font size="2" align="center" color="#661155">Aapka apna Amitabh Bachchan</font>
			</td></tr></table>
	</div>
</body>
</html> --%>
